...
import 'package:praktikum_provider/models/contact_model.dart';
...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Widget build(BuildContext context) {
    // Menggunakan contactProvider untuk mengakses data contact
            ...
            child: Column(
              children: [
                ...
                ContactsList(
                  ...
                  onDelete: (index) {
                    setState(() {
                      // Menghapus kontak berdasarkan indeks
...
class ContactsList extends StatelessWidget {
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        _showEditContactDialog(context, index, contacts[index]);
                      },
                    ),
                    IconButton(
                      icon: const Icon(
  ...
  void _showEditContactDialog(
      BuildContext context, int index, ContactModel contact) {
